...
public:
	...
	void Shutdown();
	bool Render(ID3D11DeviceContext* deviceContext, int indexCount, D3DXVECTOR4 apexColour, D3DXVECTOR4 centreColour);
private:
	...
	bool SetShaderParameters(ID3D11DeviceContext* deviceContext, D3DXVECTOR4 apexColour, D3DXVECTOR4 centreColour);
